"""
Methods to clean and reformat data. Lending Club has a large and confusing set of values that
must be preprocessed. Tasks including imputation, encoding, and scaling are necessary on the raw data.
"""
import pandas as pd
import numpy as np
